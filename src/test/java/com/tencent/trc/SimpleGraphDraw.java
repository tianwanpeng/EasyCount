 ...
 * <li/>creates a <code>VisualizationViewer</code> based on that layout and
 * renderer
 * <li/>adds the <code>VisualizationViewer</code> object to a Swing
 * <code>JFrame</code>'s content pane.
 * </ul>
...
public class SimpleGraphDraw {
	...
	public static Graph getGraph() throws IOException {
		...
		Graph g = pnr.load("testdata/simple.net");
		return g;
	}
}
