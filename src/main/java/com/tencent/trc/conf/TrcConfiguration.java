...
public class TrcConfiguration extends Configuration implements Serializable {
	...
	public static enum ConfVars {
		...
		private boolean parseBoolean(String defaultVal2) {
			try {
		...
		private float parseFloat(String defaultVal2) {
			try {
		...
		private long parseLong(String defaultVal2) {
			try {
		...
		private int parseInt(String defaultVal2) {
			try {
	...
	public TrcConfiguration(Properties properties) {
		this();
