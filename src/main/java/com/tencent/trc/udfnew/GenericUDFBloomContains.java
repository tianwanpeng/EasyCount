...
public class GenericUDFBloomContains extends GenericUDF {
	...
	public ObjectInspector initialize(ObjectInspector[] arguments)
		...
		binaryOI = (BinaryObjectInspector) arguments[ARRAY_IDX];
	...
	public Object evaluate(DeferredObject[] arguments) throws HiveException {
		...
		Object bin = arguments[ARRAY_IDX].get();
		...
		byte[] bindata = binaryOI.getPrimitiveJavaObject(bin);
		BitSet bs = BitSet.valueOf(bindata);
		BloomFilter<Integer> bf = new BloomFilter<Integer>(bs,
				BloomFilter.optimalM(n, p), BloomFilter.optimalK(n,
						BloomFilter.optimalM(n, p)));
		result.set(bf.contains((Integer) (valueOI.getPrimitiveJavaObject(value))));
		return result;
	}
