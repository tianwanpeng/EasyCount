 ...
 * 
 */
@Description(name = "map_values", value = "_FUNC_(array, value) - Returns TRUE if the array contains value.", extended = "Example:\n"
...
public class GenericUDFMapValues extends GenericUDF {
	...
	public ObjectInspector initialize(ObjectInspector[] arguments)
		...
		return ObjectInspectorFactory
				.getStandardListObjectInspector(mapvalueElementOI);
