 ...
 * 
 */
public class ExprNodeNewForDesc extends ExprNodeNewBlockDesc implements
		Serializable {
	...
	public ExprNodeNewForDesc(ExprNodeDesc condationDesc,
	...
	@Override
	public ExprNodeNewForDesc clone() {
		return new ExprNodeNewForDesc(this.condationDesc, this.blockDescs);
	}

	@Override
	public boolean isSame(Object o) {
		if (!(o instanceof ExprNodeNewForDesc)) {
			return false;
		}
		ExprNodeNewForDesc o1 = (ExprNodeNewForDesc) o;
