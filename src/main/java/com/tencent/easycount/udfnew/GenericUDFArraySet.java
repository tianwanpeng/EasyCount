...
public class GenericUDFArraySet extends GenericUDF {
	...
	public Object evaluate(DeferredObject[] arguments) throws HiveException {
		...
		if (inputsettable) {
			...
			if (arrayObj.size() <= setidx) {
				for (int i = arrayObj.size(); i <= setidx; i++) {
					arrayObj.add(null);
				}
			}
			arrayObj.set(setidx,
					ObjectInspectorUtils.copyToStandardObject(value, valueOI));
			return arrayObj;
		} else {
