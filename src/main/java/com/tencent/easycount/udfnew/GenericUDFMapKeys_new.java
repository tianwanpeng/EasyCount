...
public class GenericUDFMapKeys_new extends GenericUDF {
	...
	public Object evaluate(DeferredObject[] arguments) throws HiveException {
		retArray.clear();
		Object mapObj = ObjectInspectorUtils.copyToStandardObject(
				arguments[0].get(), mapOI, ObjectInspectorCopyOption.WRITABLE);
