 ...
 */
public class ASTNodeTRCOrigin {
	private final String objectType;
	private final String objectName;
	private final String objectDefinition;
	private final String usageAlias;
	private final ASTNodeTRC usageNode;

	public ASTNodeTRCOrigin(String objectType, String objectName,
			String objectDefinition, String usageAlias, ASTNodeTRC usageNode) {
	...
	/**
	 * @return the name of the object from which an ASTNode originated, e.g.
	 *         "v".
	 */
	...
	/**
	 * @return the alias of the object from which an ASTNode originated, e.g.
	 *         "v1" (this can help with debugging context-dependent expansions)
	 */
	 ...
	 */
	public ASTNodeTRC getUsageNode() {
		return usageNode;
	}
}
